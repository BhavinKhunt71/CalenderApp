...
import { View, Text, StyleSheet, TouchableOpacity, Image, Modal, Button,Platform } from 'react-native';
    ...
    <View style={styles.header}>
      <TouchableOpacity onPress={openDrawer} style={styles.iconContainer}>
        <Image
          ...
          style={(selectedOption == 'Year' || selectedOption== 'Month' || selectedOption == 'Events') ? styles.icon : styles.cioni }
        />
      </TouchableOpacity>
      <Text style={styles.headerText}>{(selectedOption == 'Year' || selectedOption== 'Month' )? 'Calendar': selectedOption}</Text>
      {route.name === 'Month' && (
        <>
          <TouchableOpacity onPress={openSearchComponent} style={styles.iconContainer}>
            <Image
              source={require('../assets/icon/search.png')} // Replace with your search icon source
              style={styles.iconsearch}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={openJumpToDatePopup} style={styles.iconContainer}>
            <Image
